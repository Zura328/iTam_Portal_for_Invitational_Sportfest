    ...
    <div class="container mx-auto flex justify-start ml-96 relative z-10">
        <div class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md">
            <div class="flex justify-center mb-4">
                <img src="{{ asset('images/userlogo.png')}}" alt="Logo" width="150px">
            </div>
            
            <h3 class="text-center mb-3 text-xl font-bold">Welcome User!</h3>
            <p class="text-center mb-6">To continue, please sign in</p>
            
            <form method="POST" action="{{ route('login') }}" style="z-index: 1;">
                @csrf
